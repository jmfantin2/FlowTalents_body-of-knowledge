...
public class Utilities {
  ...
  /*
   * Cria um ArrayList de items do tipo String, e imediatamente o popula com os
   * nomes dos integrantes do FlowTalents
   */
  ...
  public Compra geraCompra(ArrayList<Produto> produtos) {
    ...
    /*
     * metodo que aceita como parametro um ArrayList com items do tipo Produto.
     * executa um laço que: (for)para cada elemento do tipo Produto dentro de
     * produtos (if)se o numero aleatorio gerado entre 1 e 0 for 1 ele adiciona este
     * elemento ao ArrayList produtos dentro de compra.
     */
